  ...
  "optimizedAgents": [
    {
      ...
      "decisionAuthority": "propose-only | propose-and-execute | autonomous-low-risk | fully-autonomous",
      "interactionPattern": "request-response | event-driven | publish-subscribe | orchestrated | collaborative",
      "triggers": ["event.name", "another.trigger"],
      "outputs": ["result.type", "report.generated"],
