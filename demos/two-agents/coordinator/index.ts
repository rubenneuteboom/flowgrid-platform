...
app.http('coordinator', {
  ...
  handler: async (request: HttpRequest, context: InvocationContext): Promise<HttpResponseInit> => {
    ...
    try {
      const body = await request.json() as { task: string; data?: Record<string, unknown> };
...
app.serviceBusQueue('coordinatorInbox', {
