...
// ============================================================================
functions_1.app.serviceBusQueue('specialistInbox', {
...
// ============================================================================
async function processWithAI(payload, context) {
...
Provide 3 key insights and a confidence score (0-1).`;
        ...
        default: {
            ...
            const aiResponse = await callAzureOpenAI(`The user asked about: "${task}". Additional context: ${JSON.stringify(data || {})}. Please help.`);
            return {
                agent: AGENT_ID,
                task,
                response: aiResponse,
...
// ============================================================================
functions_1.app.http('specialist', {
    methods: ['POST'],
    authLevel: 'anonymous',
    route: 'agent/process',
...
// ============================================================================
functions_1.app.http('specialistChat', {
    methods: ['POST'],
    authLevel: 'anonymous',
    route: 'agent/chat',
    handler: async (request, context) => {
...
// Agent Card endpoint
// ============================================================================
functions_1.app.http('specialistCard', {
    methods: ['GET'],
    authLevel: 'anonymous',
